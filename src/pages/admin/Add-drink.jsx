...
import product from '../../assets/img/Transaction.png'
    ...
    return (
      <>
        ...
        <div className={cssModules.productContainer}>
          ...
          <form>
            <div>
              <input className={cssModules.productName} placeholder='Name Product' />
            </div>
            <div>
        ...
        <img src={logo} className={cssModules.productLogo} alt="" />
      </>
    )
  }
